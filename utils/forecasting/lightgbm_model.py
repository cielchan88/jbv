"""LightGBM forecaster with advanced feature engineering"""
...
class LightGBMForecaster(BaseForecaster):
    """LightGBM forecaster with advanced feature engineering and target transformation"""

    def __init__(self, holidays=None, n_estimators=100, learning_rate=0.05, max_depth=5, use_transform=False):
    ...
    def fit(self, dates, values, external_series=None):
        """Fit LightGBM model with target transformation"""
        ...
        external_series = cross_series_for_recursive(external_series, 'LightGBM')
        ...
        for next_date in future_business_dates:
            ...
            if len(temp_features) > 0:
                ...
                if not checked_missing:
                    warn_missing_at_predict(missing, 'LightGBM')
