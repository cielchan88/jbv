"""XGBoost forecaster with advanced feature engineering"""
...
class XGBoostForecaster(BaseForecaster):
    """XGBoost forecaster with advanced feature engineering and target transformation"""

    def __init__(self, holidays=None, n_estimators=100, max_depth=5, learning_rate=0.05, use_transform=False):
    ...
    def fit(self, dates, values, external_series=None):
        """Fit XGBoost model with target transformation"""
        ...
        external_series = cross_series_for_recursive(external_series, 'XGBoost')
        ...
        self.model.fit(X_train, y_train_transformed, verbose=False)
        ...
        for next_date in future_business_dates:
            ...
            if len(temp_features) > 0:
                ...
                if not checked_missing:
                    warn_missing_at_predict(missing, 'XGBoost')
